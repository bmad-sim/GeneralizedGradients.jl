...
# src/gg_eval.jl
    ...
    gg_evaluate_at(res, x::Real, y::Real, s::Real; order::Integer=3)
    gg_coefficients_at(res, s::Real; order::Integer=3)

Program to take the gg function values generated by gg_fit.jl and output the field at vector poten